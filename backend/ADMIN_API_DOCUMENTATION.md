...
```json
{
  ...
  "data": {
    "cases": [
      /* Same structure as Get All Cases */
    ],
    "pagination": {
      "current": 1,
      "pages": 3,
...
```json
{
  ...
  "data": {
    "case": {
      /* Full case object with updated status */
    }
  }
}
```
...
```json
{
  ...
  "data": {
    "case": {
      /* Full case object with updated priority */
    }
  }
}
```
...
```json
{
  ...
  "data": {
    "meeting": {
      ...
      "scheduledBy": {
        /* Full admin user object */
      },
      "attendees": [
        /* Full attendee objects with user details */
      ],
      "scheduledDate": "2025-01-20T14:00:00.000Z",
      "duration": 90,
      "meetingType": "video",
